...
<%if(Utility.parse(request.getParameter("no1"))==1)
	...
	alert('Slider OTC has been Sent to your registerd Mail ID... set the sliders accordingly ')
...
<%
	...
	<div style="position:absolute; top: 229px;left: 250px;">
			<button type="submit" name="submit" value="left1" class="btn btn-default btn-lg button"><<</button> 
		...
		<img src="6.jpg">
			...
			<div style="position:absolute; top: 229px;left: 602px;">
			 <button type="submit" name="submit" value="right1" class="btn btn-default btn-lg button">>></button>
		...
		<button type="submit" name="submit" value="up1" class="btn btn-default btn-lg button">^</button>  <br><br> <br><br><br><br><br><br> <br><br> <br><br> <br><br> <br><br><br> <button type="submit" name="submit" value="down1" class="btn btn-default btn-lg button">v</button>
		</div>
		...
		<img src="<%=request.getContextPath()%>/PasswordImages/<%=image1%>/<%=image1%>.jpg">	
		</div>
	...
	if(Utility.parse(request.getParameter("no"))==1)
    {
		...
		<div style="position:absolute; top: 229px;left: 250px;">
			<button type="submit" name="submit" value="left1" disabled="disabled" class="btn btn-default btn-lg button"><<</button> 
		...
		<img src="<%=gethorizantalimage%>.jpg">
			...
			<div style="position:absolute; top: 229px;left: 602px;">
			 <button type="submit" name="submit" value="right1" disabled="disabled"  class="btn btn-default btn-lg button">>></button>
		...
		<div style="position:absolute; top: 280px;left: 200px;">
		<button type="submit" name="submit" value="up1" disabled="disabled" class="btn btn-default btn-lg button">^</button>  <br><br> <br><br><br><br><br><br> <br><br> <br><br> <br><br> <br><br><br> <button type="submit" name="submit" value="down1" class="btn btn-default btn-lg button">v</button>
		</div>
		...
		<div style="position:absolute; top: 280px;left: 200px;">
		<button type="submit" name="submit" value="up1"  class="btn btn-default btn-lg button">^</button>  <br><br> <br><br><br><br><br><br> <br><br> <br><br> <br><br> <br><br><br> <button type="submit" name="submit" value="down1" disabled="disabled" class="btn btn-default btn-lg button">v</button>
		</div>
...
<div style="position:absolute; top: 690px;left: 350px;">
		<button type="submit" name="submit" value="slider1" class="btn btn-default btn-lg button">Submit</button>
