...
<script>
    $(document).ready(function(){
        $("#myTable td").click(function() {     
            ...
            window.location.href = "Resetimagepasswordset1.jsp?no="+2+"&x="+column_num+"&y="+row_num;
...
<body>
<%String image=session.getAttribute("randomimage1").toString();
...
<section class="wrapper">
    ...
    %>         
                ...
                <form id="registerform" method="get" name="registerform" action="<%=request.getContextPath()%>/ResetRecievescriptdata">
                    ...
                    <div class="form-group">
                     <button type="submit" name="submit" value="recieve" class="btn btn-default btn-lg button">Submit</button>
