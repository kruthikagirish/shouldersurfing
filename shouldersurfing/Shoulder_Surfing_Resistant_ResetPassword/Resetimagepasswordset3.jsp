...
<script>
    $(document).ready(function(){
        $("#myTable td").click(function() {     
            ...
            window.location.href = "Resetimagepasswordset3.jsp?no="+2+"&x="+column_num+"&y="+row_num;
...
<section class="wrapper">
    ...
    %>         
                ...
                <form id="registerform" method="get" name="registerform" action="<%=request.getContextPath()%>/ResetRecievescriptdata">
                    ...
                    <div class="form-group">
                     <button type="submit" name="submit" value="recieve3" class="btn btn-default btn-lg button">Submit</button>
