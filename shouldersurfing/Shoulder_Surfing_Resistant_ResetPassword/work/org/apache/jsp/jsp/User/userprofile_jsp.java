...
public final class userprofile_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("\n");
      out.write("<script  src=\"http://code.jquery.com/jquery-9.1.min.js\" ></script>     \n");
      out.write("\n");
      out.write("<link href=\"");
...
String uid=session.getAttribute("uid").toString(); 
      ...
      out.write("\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t<li><span>User Id: </span>");
      out.print(userid );
      out.write("</li>\n");
      out.write("\t\t\t\t\t\t\t\t<li><span>Name :</span>");
      out.print(name );
      out.write("</li>\n");
      out.write("\t\t\t\t\t\t\t\t<li><span>Gender :</span>");
      out.print(gender );
      out.write("</li>\n");
      out.write("\t\t\t\t\t\t\t\t<li><span>Mail Id:</span> ");
      out.print(email);
      out.write("</li>\n");
      out.write("\t\t\t\t\t\t\t\t<li><span>Cell No:</span> ");
      out.print(phone );
      out.write("</li>\n");
...
if(Utility.parse(request.getParameter("no"))==2)
    {
      out.write("\n");
      out.write("\t<script type=\"text/javascript\">\n");
      out.write("\talert('Profile updation Failure !!!!!')\n");
      out.write("\t\n");
      out.write("\t</script>\n");
      out.write("\t\n");
      out.write(" ");
