...
<section class="wrapper">
    ...
    <form id="registerform" method="get" name="registerform" action="<%=request.getContextPath()%>/EditAdminProfile">
     ...
     <div class="row sub_content">
           ...
           <div class="project_details">
							...
							<ul class="details">
								...
								<li><span>User Id: </span>  <input type="text" class="form-control" name="uid" value="<%=userid%>" readonly="readonly"	></li>
								<li><span>Name :</span><input type="text" class="form-control" name="adminname" value="<%=name %>" 	></li>
								<li><span>Gender :</span><input type="text" class="form-control" name="gender" value="<%=gender%>" 	></li>
								<li><span>Mail Id:</span><input type="text" class="form-control" name="email" value="<%=email%>"> </li>
								<li><span>Cell No:</span><input type="text" class="form-control" name="phone" value="<%=phone%>"> </li>
								<li><span>City:</span><input type="text" class="form-control" name="city" value="<%=city%>"> </li>
							</ul>
						</div>
						 <button type="submit" name="submit" value="update" class="btn btn-default btn-lg button">Update</button>
