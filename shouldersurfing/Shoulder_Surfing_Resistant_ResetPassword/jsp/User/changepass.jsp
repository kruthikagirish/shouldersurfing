...
<section class="wrapper">
    ...
    <form id="registerform" method="get" name="registerform" action="<%=request.getContextPath()%>/ChangePass">
     ...
     <div class="row sub_content">
           ...
           <div class="project_details">
							...
							<ul class="details">
								...
								<li><span>Current Password: </span>  <input type="text" class="form-control" name="currpass" 	></li>
								<li><span>New Password :</span><input type="text" class="form-control" name="newpass" 	></li>
