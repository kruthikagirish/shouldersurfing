...
<section class="wrapper">
    ...
    <form id="registerform" method="get" name="registerform" action="<%=request.getContextPath()%>/EditUserProfile">
     ...
     <div class="row sub_content">
           ...
           <div class="project_details">
							...
							<ul class="details">
								...
								<li><span>Name :</span><input type="text" class="form-control" name="uname" value="<%=name %>" 	></li>
