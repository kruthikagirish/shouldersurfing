...
public class ResetRecievescriptdata extends HttpServlet
...

{
	...
	{
		System.out.println("<<<<<<<<<<<<<<<<<<<<<<<<<<Its Came Inside the ResetReceiver Servlet>>>>>>>>>>>>>..");
		...
		if(submit.equals("left1"))
		{
			...
			RequestDispatcher rd=request.getRequestDispatcher("Resetslider1.jsp?no=1");
		...
		if(submit.equals("left2"))
		{
			...
			RequestDispatcher rd=request.getRequestDispatcher("Resetslider2.jsp?no=1");
			  rd.forward(request, response);
		}
		...
		//==================================================================================	
				...
				if(submit.equals("left3"))
				{
					...
					RequestDispatcher rd=request.getRequestDispatcher("Resetslider3.jsp?no=1");
					  rd.forward(request, response);
				}
			...
			if(submit.equals("Resetslider1"))
			{
				 ...
				 RequestDispatcher rd=request.getRequestDispatcher("Resetslider2.jsp?no=0");
				  rd.forward(request, response);
			}
			...
			if(submit.equals("Resetslider2"))
			{
				 ...
				 RequestDispatcher rd=request.getRequestDispatcher("Resetslider3.jsp?no=0");
				  rd.forward(request, response);
			}
	...
	//===========================================================================================
			...
			if(submit.equals("recieve"))
			{
				 String column=request.getParameter("column");
				  ...
				  boolean flag=User.updatecoordinates1(corodinates,uid);
					 ...
					 RequestDispatcher rd=request.getRequestDispatcher("Resetimagepasswordset2.jsp");
					  rd.forward(request, response);
			...
			if(submit.equals("recieve2"))
			{
				 String column=request.getParameter("column");
			      ...
			      boolean flag=User.updatecoordinates2(corodinates,uid);
					 ...
					 RequestDispatcher rd=request.getRequestDispatcher("Resetimagepasswordset3.jsp");
				  rd.forward(request, response);
			...
			if(submit.equals("recieve3"))
			{
			     ...
			     if(hashflag)
			     {
					 RequestDispatcher rd=request.getRequestDispatcher("index.jsp?no=12");
					  rd.forward(request, response);
			     }
