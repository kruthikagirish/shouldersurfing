			...
			String submit=req.getParameter("submit");
				...
				HttpSession hs=req.getSession();	
				    ...
				    if(submit.equals("pass"))
				    {
							...
							RequestDispatcher rd=req.getRequestDispatcher("/jsp/User/changepass.jsp");
							rd.forward(req, resp);
				    }
				    ...
				    if(submit.equals("changepass"))
				    {
				     ...
				     updatepass=User.updateUserpass(uid,currpass,newpass) ;
				    
				    if(updatepass)
				    {
				   
					RequestDispatcher rd=req.getRequestDispatcher("/jsp/User/changepass.jsp?no=1");
					rd.forward(req, resp);
				    }
				    else
				    {
				   
					RequestDispatcher rd=req.getRequestDispatcher("/jsp/User/changepass.jsp?no=2");
					rd.forward(req, resp);
				    }
				    }
